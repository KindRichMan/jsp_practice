<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
       ...
       // if~else문을 활용해주세요.
    %>
    <% // auto login관련해서 발급된 쿠키가 있는지 체크해서 쿠키가 있다면
...
<body>
    ...
    <form action="cookie_login_ok.jsp" method="post">
        ...
        자동로긴 : <input type="checkbox" name="auto" value="checked"><br/>
