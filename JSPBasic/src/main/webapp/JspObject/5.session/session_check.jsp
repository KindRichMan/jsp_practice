<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
      /* 
        ...
        - 세션에 저장된 데이터를 가져오려면 SESSION 객체의 getAttribute() 메서도를
          사용하면, 매개값으로 가져올 데이터의 세션 이름을 적어줍니다.
      ...
      */
      ...
      out.println("세션의 유효시시간 :" + sTime + "초<br/>");
      out.println("=============================<br/>");
      
      // 특정 세션 데이터만 삭제하기
      id = (String)session.getAttribute("name_session");
      out.println("name_session 삭제전 : " + id +"<br/>");
      ...
      id = (String)session.getAttribute("name_session");
      out.println("name_session 삭제후 : " + id +"<br/>");
      ...
      user  = (String)session.getAttribute("JSP");
      out.println("id_session 삭제 전  : " + userId +"<br/>");
      out.println("JSP 삭제 전  : " + user +"<br/>");
