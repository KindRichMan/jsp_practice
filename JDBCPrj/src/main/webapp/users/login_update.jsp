...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
     // 1. 세션에서 아이디를 얻어와 변수에 저장합니다. 세션 결과값이 널이면 login_form.jsp로 이동
    ...
    if(sId == null){
     ...
     // 상위지역에서 미리 tEmail, tEmail을 선언 및 초기화해놔야
     ...
     try{
    	 ...
    	 Connection con = DriverManager.getConnection(dbUrl, dbId, dbId);
